...
module.exports.views = {
	...
	// default vars for views
    locals: {
        checkPerms: function (req, perm, controller) {
            var user = req.session.Admin || false;

            if(!user) return false;

            if (user.superAdmin) return true;

            return _.contains(user.permissions[perm], controller.toLowerCase());
        }
